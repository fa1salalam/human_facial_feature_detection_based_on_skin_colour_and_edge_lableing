function eyebrows=detectEyebrows(face)
...
%figure,imshow(eyebrows);
eyebrows = insertShape(eyebrows, 'rectangle', [left_ebw-20 left_ebh+40 200 50], 'LineWidth', 10);
%figure,imshow(eyebrows);
...
%figure,imshow(eyebrows);
eyebrows = insertShape(eyebrows, 'rectangle', [right_ebw-40 right_ebh-10 200 50], 'LineWidth', 10);
%figure,imshow(eyebrows);
