function eyes=detectEyes(face,edge)
...
%figure,imshow(eyes);
eyes = insertShape(eyes, 'rectangle', [left_ebw+40 left_ebh+300 120 50], 'LineWidth', 10);
%figure,imshow(eyes);
...
%figure,imshow(eyes);
eyes = insertShape(eyes, 'rectangle', [right_ebw-25 right_ebh+75 120 50], 'LineWidth', 10);
%figure,imshow(eyes);
